...
Eigen::Matrix3d Jaco2KinematicModel::skewSymMat(const KDL::Vector &vec)
{
    Eigen::Matrix3d res;
    res << 0    , -vec(2)   , vec(1),
            vec(2), 0         , -vec(0),
...
/*
Eigen::Matrix<double, 3, 6> Jaco2KinematicModel::inertiaProductMat(const KDL::Vector &vec)
{
...
Eigen::Matrix<double, 6, 6> Jaco2KinematicModel::kdlFrame2Spatial(const KDL::Frame &frame)
{
...
Eigen::Matrix<double, 3, 3> Jaco2KinematicModel::kdlMatrix2Eigen(const KDL::Rotation &rot)
{
...
void Jaco2KinematicModel::kdlJntArray2Eigen(const KDL::JntArray &q, Eigen::VectorXd& res)
{
    res.setZero(q.rows());
...
void Jaco2KinematicModel::kdlMatrix2Eigen(const KDL::JntSpaceInertiaMatrix& mat, Eigen::MatrixXd & res)
{
