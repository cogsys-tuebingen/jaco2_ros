...
AngularAcceleration ConvertAccelerometers::data2kinova(const jaco2_data::AccelerometerData& data)
{
    ...
    res.Actuator1_X = data[0].vector(0);
    res.Actuator1_Y = data[0].vector(1);
    res.Actuator1_Z = data[0].vector(2);

    res.Actuator2_X = data[1].vector(0);
    res.Actuator2_Y = data[1].vector(1);
    res.Actuator2_Z = data[1].vector(2);

    res.Actuator3_X = data[2].vector(0);
    res.Actuator3_Y = data[2].vector(1);
    res.Actuator3_Z = data[2].vector(2);

    res.Actuator4_X = data[3].vector(0);
    res.Actuator4_Y = data[3].vector(1);
    res.Actuator4_Z = data[3].vector(2);

    res.Actuator5_X = data[4].vector(0);
    res.Actuator5_Y = data[4].vector(1);
    res.Actuator5_Z = data[4].vector(2);

    res.Actuator6_X = data[5].vector(0);
    res.Actuator6_Y = data[5].vector(1);
    res.Actuator6_Z = data[5].vector(2);
