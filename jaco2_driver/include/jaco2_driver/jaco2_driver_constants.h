...
const std::string name_accel_1("jaco_accelerometer_1");
const std::string name_accel_2("jaco_accelerometer_2");
const std::string name_accel_3("jaco_accelerometer_3");
const std::string name_accel_4("jaco_accelerometer_4");
const std::string name_accel_5("jaco_accelerometer_5");
const std::string name_accel_6("jaco_accelerometer_6");
