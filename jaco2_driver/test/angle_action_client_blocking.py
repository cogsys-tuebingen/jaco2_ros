...
def pose_client():
    client = actionlib.SimpleActionClient('/jaco_arm_driver/arm_joint_angles_blocking', jaco2_msgs.msg.ArmJointAnglesAction)
...
if __name__ == '__main__':
    try:        
        rospy.init_node('arm_pose_client_blocking', anonymous=True)
        result = pose_client()
